...
import { ProductMongoDBEntity, ProductMongoDBEntitySchema } from 'src/infrastructure/mongodb/entities/product.mongodb-entity'; 
...
@Module({
  ...
  exports: [UseProductRead, UseProductCreate, UseProductDelete, UseProductUpdate, UseProductRead], 
})
